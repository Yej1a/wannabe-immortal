(function initGameData(global) {
  ...
  const destinyCatalog = {
    ...
    wanjian: {
      ...
      baseCost: 20,
      text: {
        technique: "飞剑未分路时先提高飞行速度与少量额外出手；锁定剑潮流后，显著放大剑潮数量、速度与追杂覆盖。",
      },
    },
    juque: {
      id: "juque",
      ...
      baseCost: 20,
      text: {
        technique: "飞剑未分路时先提高单剑伤害与命中宽度；锁定大剑流后，显著放大巨剑体型、伤害与镇场持续时间。",
      },
    },
    heguang: {
      id: "heguang",
    ...
    jiuzhuan: {
      ...
      baseCost: 20,
      text: {
        technique: "雷法未分路时先提高追链稳定性；锁定连锁流后，大幅提高连锁次数、范围与补漏能力。",
      },
    },
    leiyu: {
      id: "leiyu",
      ...
      baseCost: 20,
      text: {
        technique: "雷法未分路时先提高主动技范围与落点稳定性；锁定落雷流后，大幅扩大雷区、密度与持续时间。",
      },
    },
    jiehuo: {
      id: "jiehuo",
      ...
      baseCost: 20,
      text: {
        technique: "火环未分路时先提高近身压迫与点燃持续；锁定伤害流后，大幅强化贴脸高热、灼烧叠层与陨火爆发。",
      },
    },
    lihuo: {
      id: "lihuo",
      ...
      baseCost: 20,
      text: {
        technique: "火环未分路时先提高外圈存在感；锁定范围流后，大幅扩大火场、留焰时长与封路稳定性。",
      },
    },
    xuangang: {
      id: "xuangang",
      ...
      baseCost: 20,
      text: {
        technique: "金钟未分路时先提高护体稳定性；锁定厚盾流后，大幅提高护体厚度、稳场覆盖与未破时的缓慢回补。",
      },
    },
    fantian: {
      id: "fantian",
      ...
      baseCost: 20,
      text: {
        technique: "金钟未分路时先提高受击震荡与击退；锁定弹反流后，大幅强化反弹、反震与终结反打。",
      },
    },
    yinyang: {
      id: "yinyang",
    ...
    thunder: {
      ...
      routes: {
        storm: {
          ...
          shortLabel: "落雷",
          activeName: "掌心雷·天罚",
          activeDescription: "留下一个雷池，持续落雷轰击范围内敌人。",
          capstoneName: "九霄雷池",
          identityTags: ["区域统治", "雷池", "持续降雷", "开窗爆发"],
          activeClimaxText: "区域雷池接管战场",
          graduationSummary: "普攻负责日常补漏，主动技会留下持续降雷的雷池接管局部战场。",
    ...
    flame: {
      ...
      routes: {
        meteor: {
          ...
          graduationSummary: "火环负责持续近身灼烧，主动技会以更多陨石覆盖落点区域。",
